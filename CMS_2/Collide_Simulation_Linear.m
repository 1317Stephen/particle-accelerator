function [  ] = Collide_Simulation_Linear(index, time_faster, main_course,sub_course1, sub_course2, sub_course3, sub_course4, sub_course5 )
...
% 
    particle2_px =main_course(1,i);
    particle2_py = main_course(2,i);
    particle2_z =main_course(3,i);
...
% 
    hold off;
	pause(0.05 - time_factor *j - time_faster);
% 	pause(0.01);
end
