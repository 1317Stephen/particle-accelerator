function [  ] = Collide_Simulation(index, time_faster, main_course, sub_course1, sub_course2, sub_course3, sub_course4, sub_course5 )
...
for i=index
    ...
    if index(1) ==1
        ...
        particle2_px = main_course(1,index(end-j));
        particle2_py = main_course(2,index(end-j));
        particle2_z = main_course(3,index(end-j));
    end
